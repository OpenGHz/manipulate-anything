    ...
    while True:
        ...
        with lock:
            ...
            if args.variations >= 0:
                possible_variations = np.minimum(args.variations, possible_variations)
            if my_variation_count >= possible_variations:
...
def parse_args():
    ...
    parser.add_argument('--save_path', type=str, default='data/GT_12T_100EP', help='Where to save the demos.')
    parser.add_argument('--tasks', nargs='*', default=["lamp_on"], help='The tasks to collect. If empty, all tasks are collected.')
    parser.add_argument('--image_size', nargs=2, type=int, default=[256, 256], help='The size of the images to save.')
    ...
    parser.add_argument('--episodes_per_task', type=int, default=90, help='The number of episodes to collect per task.')
